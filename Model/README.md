...
|№|Пример|Комментарий|
|:---:|:---:|:---:|
|1|Распознавание на сложном фоне|![Sparrow](img/examples/sparrow.jpg)|
|2|Распознавание на сложном фоне|![Cardinal](img/examples/cardinal.jpg)|
|3|Идентификация нескольких птиц|![Sparrow 1](img/examples/doves.jpg)|
|4|Идентификация нескольких птиц|![Sparrow 1](img/examples/many_birds.jpg)|


Папка, содержащая все результаты из test dataset: https://drive.google.com/drive/folders/12-FYgXOdrZHqsnmSwu2EYR4H9zq9J1SK?usp=share_link

## <a id=6>Выводы</a>
Модель продемонстрировала хорошие метрики в задаче распознавания птиц как в случае изображений птиц крупным планом, так и для их распознавании их присутствия в кормушке, даже в том случае, когда птиц было несколько и их изображения были сравнительно мелкие.


**Возможные направления дальнейшей реализации проекта:**
1) Увеличение количества классов для более полного покрытия основных типов птиц, присутствующих в конкретной локации, а также дискриминации схожих видов птиц (например, голуби, горлинки и вяхири)
2) Деплой полученных моделей на автономных устройствах, таких как Raspberri PI и их установка в кормушки для птиц с подключением к аккумулятору.
3) Сбор и анализ данных о типичных птицах, посещающих кормушки, в зависимости от сезона,  локации, времени суток, погоды,
4) Разработка умных кормушек для орнитологов-энтузиастов, позволяющих определять момент прилета редких птиц в кормушку.
